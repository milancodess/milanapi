...
app.get('/sb', async (req, res) => {
	...
	const top1 = $("div:contains('Top 1')").next().find('.font-bold').first().text().trim();
        const top3 = $("div:contains('Top 3')").next().find('.font-bold').first().text().trim();
        const party = $("div:contains('Party')").next().find('.font-bold').first().text().trim();
